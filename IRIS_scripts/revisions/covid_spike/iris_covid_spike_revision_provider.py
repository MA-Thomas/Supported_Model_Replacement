...
IRIS_SCRIPTS_ROOT = SCRIPT_DIR.parents[1]
REPOSITORY_ROOT = IRIS_SCRIPTS_ROOT.parent
sys.path.insert(0, str(IRIS_SCRIPTS_ROOT / "providers"))
import iris_score_provider as provider


DEFAULT_BASE_BUNDLES = IRIS_SCRIPTS_ROOT / "prebuilt_bundles/threshold_zero"
DEFAULT_HIGHER_THRESHOLD_BUNDLES = (
    IRIS_SCRIPTS_ROOT / "prebuilt_bundles/higher_threshold_0p53"
)
DEFAULT_ORGANIZER = (
    REPOSITORY_ROOT
