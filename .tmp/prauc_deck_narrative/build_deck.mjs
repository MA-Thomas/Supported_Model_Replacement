...
const OUT_DIR = "/Users/thomm15/Documents/Stats_Paper_AUPRC_extension/.tmp/prauc_deck_narrative/rendered";
const FINAL_PPTX = "/Users/thomm15/Documents/Stats_Paper_AUPRC_extension/Stats_Paper_Extending_PRAUC_v12_slides_narrative.pptx";
...
addTwoColumnSlide(presentation, {
  title: "The same ranking can produce a very different selected set",
  section: "The problem",
  accent: C.coral,
  leftFill: C.tealSoft,
...
addThreeColumnSlide(presentation, {
  title: "A portable performance claim must declare three challenges",
  section: "The problem",
  accent: C.blue,
  items: [
...
addFormulaSlide(presentation, {
  title: "First, change the target population—not the ranking",
...
addFormulaSlide(presentation, {
  title: "Prior odds separate population shift from ranking evidence",
  section: "Problem I · Prior standardization",
  accent: C.blue,
...
addTwoColumnSlide(presentation, {
  title: "But reweighting requires stable within-class score behavior",
...
addFormulaSlide(presentation, {
  title: "Then CNAP puts every target prevalence on a common scale",
...
addLineChartSlide(presentation, {
  title: "Prevalence-robust performance is the weakest point of the profile",
...
addThreeColumnSlide(presentation, {
  title: "Beyond prevalence, what changes across replications?",
...
addTwoColumnSlide(presentation, {
  title: "A complete assessment may need two challenge modes",
...
addFormulaSlide(presentation, {
  title: "Averaging replications can hide a defeated claim",
...
addThreeColumnSlide(presentation, {
  title: "Projected support describes possible—not completed—replications",
...
addFormulaSlide(presentation, {
  title: "Support combines prevalence and replication challenges",
...
addTwoColumnSlide(presentation, {
  title: "Prevalence minimization must occur inside every replication",
...
addThreeColumnSlide(presentation, {
  title: "Low support can reflect prevalence fragility, replication instability, or both",
  section: "Problem III · Why operator order matters",
  accent: C.coral,
  items: [
...
addFormulaSlide(presentation, {
  title: "Broader challenge sets can only lower raw support",
...
addProcessSlide(presentation, {
  title: "Estimate support by bootstrapping the full prevalence profile",
...
addFormulaSlide(presentation, {
  title: "A finite prevalence grid certifies only a finite challenge set",
...
addTwoColumnSlide(presentation, {
  title: "Finite-design chance can displace the population-zero reference",
...
addFormulaSlide(presentation, {
  title: "Permutation calibration gives one model a design-relative scale",
...
addTwoColumnSlide(presentation, {
  title: "Separate calibrated reports cannot justify model replacement",
...
addTwoColumnSlide(presentation, {
  title: "Ordinary pairing can still reward arbitrary score refinement",
...
addFormulaSlide(presentation, {
  title: "Tie averaging removes artificial advantage from arbitrary within-tie order",
...
addFormulaSlide(presentation, {
  title: "Pair model differences before prevalence and replication checks",
...
addThreeColumnSlide(presentation, {
  title: "A zero-reference guarantee requires exchangeable labels",
...
addFormulaSlide(presentation, {
  title: "A coherent replacement rule may return no verdict",
...
addThreeColumnSlide(presentation, {
  title: "Π★, ℛ, and K define supported performance",
...
addThreeColumnSlide(presentation, {
  title: "Report supported performance, design, and diagnostics separately",
...
addTwoColumnSlide(presentation, {
  title: "Sparse positives make the supported prevalence profile coarse",
...
addThreeColumnSlide(presentation, {
  title: "Four tempting conclusions remain outside the method’s scope",
...
addFormulaSlide(presentation, {
  title: "Supported performance survives every declared challenge",
  section: "Conclusion",
  accent: C.blue,
  latexLines: [
    String.raw`Z_j=\inf_{π∈Π_{∗}}\operatorname{CNAP}_π(D_j)`,
...
addFormulaSlide(presentation, {
  title: "Independent joint survival forces a power distortion",
...
addProofSlide(presentation, {
  title: "Pairing before subtraction prevents overstated model advantage",
...
addProcessSlide(presentation, {
  title: "Tie-averaged AP needs no tie-order enumeration",
